  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden py-20 md:py-32 bg-background">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -bottom-20 hidden lg:block z-0">
          <img 
            src="https://cdn.poehali.dev/projects/f29328d7-0554-45ad-b0b0-d0edfcf7a0f1/files/62eadb2a-2ef3-44f9-bee9-23efbd707ad0.jpg"
            alt="boombox"
            className="w-96 h-auto animate-float opacity-70"
